...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install ColorPicker</h2>

        <p>Thanks for installing ColorPicker. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade ColorPicker</h2>

        <p>ColorPicker will be upgraded. This open source extra was developped by
