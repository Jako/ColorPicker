...
Ext.ux.ColorPicker = Ext.extend( Ext.BoxComponent, {
	...
	renderComponent: function() {
		...
		Ext.DomHelper.append( this.cpGetId( 'cCont' ), { 'cls': 'x-btn x-btn-small x-cp-colorbox x-cp-websafe', 'id': this.cpGetId( 'cWebSafe' ) }, true ).update( 'Websafe' );
		Ext.DomHelper.append( this.cpGetId( 'cCont' ), { 'cls': 'x-btn x-btn-small x-cp-colorbox x-cp-inverse', 'id': this.cpGetId( 'cInverse' ) }, true ).update( 'Inverse' );
		Ext.DomHelper.append( this.cpGetId( 'cCont' ), { 'cls': 'x-btn x-btn-small x-cp-colorbox x-cp-pickcolor', 'id': this.cpGetId( 'cColor' ) }, true ).update( 'Pick Color' );
